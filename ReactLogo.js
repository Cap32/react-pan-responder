...
export default class ReactLogo extends Component {
	static propTypes = {
		className: PropTypes.string,
		style: PropTypes.object,
		pathStrokeWidth: PropTypes.number,
		pathFillColor: PropTypes.string,
		pathStrokeColor: PropTypes.string,
		bigCircleFillColor: PropTypes.string,
		smallCircleFillColor: PropTypes.string,
